...
test("Solution demo - reliable DNA access using utility functions", async () => {
  await runScenarioWithTwoAgents(
    async (_scenario: Scenario, alice: PlayerApp, bob: PlayerApp) => {
      ...
      console.log(
        `   Alice requests_and_offers DNA found at index: ${aliceIndex}`,
      );
      console.log(`   Bob requests_and_offers DNA found at index: ${bobIndex}`);

      assert.isNotNull(
        aliceRequestsAndOffers,
        "Alice requests_and_offers cell should be found",
      );
      assert.isNotNull(
        bobRequestsAndOffers,
        "Bob requests_and_offers cell should be found",
      );
      ...
      console.log(
        "   ✅ Successfully created service type using reliable cell access",
      );
      ...
      console.log(
        "   ✅ Successfully retrieved service types using reliable cell access",
      );
      ...
      console.log(
        "   ✅ Both agents can access data using reliable cell references",
      );
...
test("Solution demo - using the wrapper function for even cleaner code", async () => {
  await runScenarioWithReliableCells(
    async (
      ...
      console.log(
        "✅ All DNA cells are automatically identified and passed as parameters",
      );
      ...
      const aliceServiceTypes = await getAllServiceTypes(
        aliceRequestsAndOffers,
      );
      const bobServiceTypes = await getAllServiceTypes(bobRequestsAndOffers);
      ...
      console.log(
        "🎉 WRAPPER SOLUTION WORKS: Clean, reliable, and easy to use!",
      );
    },
  );
});
