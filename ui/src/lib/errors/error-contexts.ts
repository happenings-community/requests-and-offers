...
export const HREA_CONTEXTS = {
  ...
  CREATE_AGREEMENT: `Failed to ${BASE_CONTEXTS.CREATE} hREA agreement`,
  CREATE_COMMITMENT: `Failed to ${BASE_CONTEXTS.CREATE} hREA commitment`,
  UPDATE_COMMITMENT: `Failed to ${BASE_CONTEXTS.UPDATE} hREA commitment`,
  CREATE_ECONOMIC_EVENT: `Failed to ${BASE_CONTEXTS.CREATE} hREA economic event`,
