...
// import { HolochainClientServiceTag } from '$lib/services/holochain-client.service';
...
//   readonly createExchangeProposal: (input: CreateExchangeProposalInput) => E.Effect<Record, ExchangeError>;
//   readonly getExchangeProposal: (proposalHash: ActionHash) => E.Effect<Record | null, ExchangeError>;
//   readonly updateProposalStatus: (input: UpdateProposalStatusInput) => E.Effect<ActionHash, ExchangeError>;
...
//   readonly deleteExchangeProposal: (proposalHash: ActionHash) => E.Effect<ActionHash, ExchangeError>;
...
//   readonly updateAgreementStatus: (input: UpdateAgreementStatusInput) => E.Effect<ActionHash, ExchangeError>;
//   readonly validateCompletion: (input: ValidateCompletionInput) => E.Effect<ActionHash, ExchangeError>;
...
//   readonly createExchangeEvent: (input: CreateExchangeEventInput) => E.Effect<Record, ExchangeError>;
...
//   readonly createMutualValidation: (input: CreateMutualValidationInput) => E.Effect<Record, ExchangeError>;
...
//   readonly createMutualCancellation: (input: CreateMutualCancellationInput) => E.Effect<Record, ExchangeError>;
//   readonly createUnilateralCancellation: (input: CreateUnilateralCancellationInput) => E.Effect<Record, ExchangeError>;
//   readonly respondToCancellation: (input: RespondToCancellationInput) => E.Effect<ActionHash, ExchangeError>;
//   readonly adminReviewCancellation: (input: AdminReviewCancellationInput) => E.Effect<ActionHash, ExchangeError>;
//   readonly getCancellationsForAgreement: (agreementHash: ActionHash) => E.Effect<Record[], ExchangeError>;
...
//           }
//           return E.fail(
//             ExchangeError.fromError(error, EXCHANGE_CONTEXTS.CREATE_EXCHANGE_PROPOSAL)
//           );
//         })
//       );
...
//           }
//           return E.fail(
//             ExchangeError.fromError(error, EXCHANGE_CONTEXTS.UPDATE_PROPOSAL_STATUS)
//           );
//         })
//       );
...
//           }
//           return E.fail(
//             ExchangeError.fromError(error, EXCHANGE_CONTEXTS.GET_PROPOSALS_FOR_ENTITY)
//           );
//         })
//       );
...
//           }
//           return E.fail(
//             ExchangeError.fromError(error, EXCHANGE_CONTEXTS.GET_PROPOSALS_BY_STATUS)
//           );
//         })
//       );
...
//     const deleteExchangeProposal = (proposalHash: ActionHash): E.Effect<ActionHash, ExchangeError> =>
//       pipe(
...
//           }
//           return E.fail(
//             ExchangeError.fromError(error, EXCHANGE_CONTEXTS.DELETE_EXCHANGE_PROPOSAL)
//           );
//         })
//       );
...
//           }
//           return E.fail(
//             ExchangeError.fromError(error, EXCHANGE_CONTEXTS.CREATE_AGREEMENT)
//           );
//         })
//       );
...
//           }
//           return E.fail(
//             ExchangeError.fromError(error, EXCHANGE_CONTEXTS.UPDATE_AGREEMENT_STATUS)
//           );
//         })
//       );
...
//           }
//           return E.fail(
//             ExchangeError.fromError(error, EXCHANGE_CONTEXTS.VALIDATE_COMPLETION)
//           );
//         })
//       );
...
//           }
//           return E.fail(
//             ExchangeError.fromError(error, EXCHANGE_CONTEXTS.GET_AGREEMENTS_BY_STATUS)
//           );
//         })
//       );
...
//           }
//           return E.fail(
//             ExchangeError.fromError(error, EXCHANGE_CONTEXTS.GET_AGREEMENTS_FOR_AGENT)
//           );
//         })
//       );
...
//           }
//           return E.fail(
//             ExchangeError.fromError(error, EXCHANGE_CONTEXTS.CREATE_EXCHANGE_EVENT)
//           );
//         })
//       );
...
//           }
//           return E.fail(
//             ExchangeError.fromError(error, EXCHANGE_CONTEXTS.GET_EVENTS_FOR_AGREEMENT)
//           );
//         })
//       );
...
//           }
//           return E.fail(
//             ExchangeError.fromError(error, EXCHANGE_CONTEXTS.CREATE_MUTUAL_VALIDATION)
//           );
//         })
//       );
...
//           }
//           return E.fail(
//             ExchangeError.fromError(error, EXCHANGE_CONTEXTS.CREATE_PUBLIC_REVIEW)
//           );
//         })
//       );
...
//           }
//           return E.fail(
//             ExchangeError.fromError(error, EXCHANGE_CONTEXTS.RESPOND_TO_CANCELLATION)
//           );
//         })
//       );
...
//     const getCancellationsForAgreement = (agreementHash: ActionHash): E.Effect<Record[], ExchangeError> =>
//       pipe(
//         holochainClient.callZomeRawEffect('exchanges', 'get_cancellations_for_agreement', agreementHash),
//         E.map((records) => records as Record[]),
//         E.catchAll((error) => {
//           if (error instanceof ExchangeError) {
//             return E.fail(error);
