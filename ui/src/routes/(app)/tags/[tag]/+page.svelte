<script lang="ts">
  ...
  <section class="container mx-auto space-y-8 p-4">
    ...
    {:else if pageState.error}
      <div class="alert variant-filled-error">
        ...
        <div class="alert-actions">
          <button class="btn btn-sm" onclick={loadTagData}>
            Try Again
          </button>
        </div>
      </div>
    ...
    {:else}
      ...
      <div class="space-y-4">
        <div class="flex items-center justify-between">
          ...
          {#if pageState.serviceTypes.length > 6}
            <a href="/service-types?tag={encodeURIComponent(tag)}" class="btn variant-soft-primary">
      ...
      <div class="space-y-4">
        <div class="flex items-center justify-between">
          ...
          {#if pageState.requests.length > 5}
            <a href="/requests?tag={encodeURIComponent(tag)}" class="btn variant-soft-secondary">
      ...
      <div class="space-y-4">
        <div class="flex items-center justify-between">
          ...
          {#if pageState.offers.length > 5}
            <a href="/offers?tag={encodeURIComponent(tag)}" class="btn variant-soft-tertiary">
      ...
      <!-- Navigation -->
      <div class="text-center">
        <a href="/service-types" class="btn variant-soft">
          Explore All Service Types
        </a>
      </div>
    {/if}
  </section>